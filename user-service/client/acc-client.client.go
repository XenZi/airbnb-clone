...
func NewAccClient(host, port string, client *http.Client, circuitBreaker *gobreaker.CircuitBreaker) *AuthClient {
	return &AuthClient{
...
func (ac AuthClient) DeleteUserAccommodations(ctx context.Context, id string) *errors.ErrorStruct {

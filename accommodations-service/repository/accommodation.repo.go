...
func (ar *AccommodationRepo) SearchAccommodations(ctx context.Context, city, country string, numOfVisitors int, minPrice int, maxPrice int, conveniences []string) ([]do.Accommodation, *errors.ErrorStruct) {
